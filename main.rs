...
/* FONCTION EXEMPLE
Pour l'exemple, nous allons configurer la broche 2 comme sortie, la mettre à un état haut et
lire son état
*/
...
pub extern "C" fn main() -> ! {
    ...
    let state = digital_read(2); // Lit l'état de la broche 2 et le stock dans state
}
